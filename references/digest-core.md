...
9. **汇报** —— 告诉用户:新建了哪些节点、更新了哪些、是否有冲突待裁决、是否因幂等检查跳过或合并了重复来源;若发现重要依赖,还要说明哪些已随本次摄取、哪些未摄取及其影响。若命中「重点高亮」内容(重大事故 / 指标剧变 / 涉及你或你关注的人的重要指令等)→ 单独、显眼地提醒。最终汇报前不要让用户等到最后才第一次看到进展。
